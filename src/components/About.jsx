...
const About = () => {
  return (
    <Flex paddingTop={"4rem"} id="about" flexDir={{ base: "column", md: "row" }} alignItems={{ base: "center", md: "start" }}>
      <Flex flexDirection={"column"} fontFamily={"Inria Sans"} color={"white"} alignItems={"center"} flex={2} textAlign={{ base: "center", md: "left" }}>
